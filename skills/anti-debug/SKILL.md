---
name: anti-debug
description: Anti-debugging detection and bypass ‚Ä?ptrace, debugger detection, timing checks, breakpoint detection. Trigger: anti debug, debugger detect, bypass debug, ptrace, anti-debugging, ÂèçË∞ÉËØ?
---
...
### Linux
- ptrace(PTRACE_TRACEME) ‚Ä?if fails, debugger attached
- /proc/self/status ‚Ü?TracerPid field
...
- NtGlobalFlag in PEB
- CloseHandle with invalid handle ‚Ü?exception if debugged
- Timing: QueryPerformanceCounter / rdtsc

### macOS
- ptrace(PT_DENY_ATTACH)
- sysctl kinfo_proc ‚Ü?p_flag & P_TRACED
